-- File: part5.adb
-- TODO: Change F3 so that it takes >0.5s based on rand number
-- Make Watchdog print warning message when F3 takes >0.5s
-- Re-sync schedule so F1 starts on second mark
